...
Example: infile 'C:\data\fevs_2017_prdf.csv'
*/
...
data temp;
  length	AGENCY $2
			...
			Q1-Q71 $1 
			RANDOM $12;
  infile 'C:\Users\KHess\Desktop\fevs_2017_prdf.csv' missover dsd dlm=',' firstobs=2;
...
ods pdf file='C:\data\PRDF 2017 Unweighted Formatted Data Frequencies - actual.pdf' style=minimal;
